...
library(readxl)
raw <- read_excel("Umfragedaten.xlsx")
View(raw)

#### Daten bereinigen ----
names(raw)
raw.short <- raw[,c(-1:-17, -21:-35, -83:-127) ]
names(raw.short)
view(raw.short)
### Codebook erstellen


#daten_neu <- haven::read_sav("daten.sav")

#daten_neu$kut_1


library(readxl)
codebook_final <- read_excel("codebook_final.xlsx")
View(codebook_final)
